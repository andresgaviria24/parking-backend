...
type Parking struct {
	Id                int32     `gorm:"TYPE:uniqueidentifier;PRIMARY_KEY;NOT NULL;COLUMN:id" json:"id"`
	FechaIngreso      time.Time `gorm:"TYPE:datetime;;NOT NULL;COLUMN:fechaIngreso" json:"fechaIngreso"`
	...
	FechaRegistro     time.Time `gorm:"TYPE:datetime;NOT NULL;COLUMN:fechaRegistro" json:"fechaRegistro"`
}
